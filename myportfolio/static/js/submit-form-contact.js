 ...
 (function(){
	...
	form.addEventListener('submit', async function(e){
		...
		try{
			...
			const endpoint = 'https://endpoint-production-2289.up.railway.app/contact-endpoint/';
			...
			// retry against the Django dev server at localhost:8000.
			    if((res.status === 405 || res.status === 404 || res.status === 0) && !endpoint.startsWith('https://endpoint-production-2289.up.railway.app')){
				    const fallback = 'https://endpoint-production-2289.up.railway.app/contact-endpoint/';
				try{
