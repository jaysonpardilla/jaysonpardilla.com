 ...
 (function(){
	...
	form.addEventListener('submit', async function(e){
		...
		try{
			...
			const endpoint = 'https://api-1-ntrg.onrender.com/contact-endpoint/';
			...
			// retry against the Django dev server at localhost:8000.
			    if((res.status === 405 || res.status === 404 || res.status === 0) && !endpoint.startsWith('https://api-1-ntrg.onrender.com')){
				    const fallback = 'https://api-1-ntrg.onrender.com/contact-endpoint/';
				try{
